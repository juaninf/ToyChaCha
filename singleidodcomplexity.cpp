...
// g++ singleidodcomplexity.cpp && ./a.out
...
int main()
{
  ...
  cout << "Average totalcompl. = 2^{" << setprecision(4) << (double)log2((firstSum / sampleKeySize) + (secondSum / sampleKeySize)) << "}\n\n";
