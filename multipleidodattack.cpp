// the multibit attack program in the 8 bit Toy-ChaCha-32 cipher
// (ID - OD)_1 = ((13,0) - (1,6))
// (ID - OD)_2 = ((14,0) - (2,6))
// (ID - OD)_3 = ((15,0) - (3,6))
// 3 round attack
...
// g++ multipleidodattack.cpp && ./a.out
...
// ul SIG2[] = { 23, 22, 21, 20, 19, 18, 17, 16 };

// ul PNB3[] = { 7,6,5,4,3,2,1,0 };
// ul SIG3[] = { 31, 30, 29, 28, 27, 26, 25, 24 };
